...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  const handleGoogleLogin = () => {
    // Simulation of a secure Google Login flow
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 text-center">
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center shadow-xl shadow-yellow-400/20">
        ...
        <div className="mt-8 space-y-4">
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
            ...
            <p className="mt-4 text-xs text-gray-400">
              We verify the authenticity of your account to ensure platform quality.
            </p>
          </div>
        </div>
      </div>
